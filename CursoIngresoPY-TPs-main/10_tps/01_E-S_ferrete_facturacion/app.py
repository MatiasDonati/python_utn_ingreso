...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        numero_1 = int(self.txt_importe_1.get())
        numero_2 = int(self.txt_importe_2.get())
        numero_3 = int(self.txt_importe_3.get())
        resultado = str(numero_1 + numero_2 + numero_3)
        alert(message="El resultado de la sumas es: " + resultado)

    def btn_promedio_on_click(self):
        numero_1 = int(self.txt_importe_1.get())
        numero_2 = int(self.txt_importe_2.get())
        numero_3 = int(self.txt_importe_3.get())
        resultado = str((numero_1 + numero_2 + numero_3) / 3)
        alert(message="El resultado de la promedio es: " + resultado)
    ...
    def btn_precio_final_on_click(self):
        ...
        precio_con_iva = resultado = resultado + (resultado * 0.21)
        alert(message="El precio final, incluido IVA es: " +  str(precio_con_iva)) 
