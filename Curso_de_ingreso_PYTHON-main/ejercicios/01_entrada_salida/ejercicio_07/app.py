...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert(message="El resultado de la suma es: " + suma)
    ...
    def btn_restar_on_click(self):
        ...
        alert(message="El resultado de la resta es: " + resta)

    def btn_multiplicar_on_click(self):
        numero_a = int(self.txt_operador_a.get())
        numero_b = int(self.txt_operador_b.get())
        multipliacion = str(numero_a * numero_b)
        alert(message="El resultado de la multipliación es: " + multipliacion)

    def btn_dividir_on_click(self):
        numero_a = int(self.txt_operador_a.get())
        numero_b = int(self.txt_operador_b.get())
        division = int(numero_a / numero_b)
        resultado_division = str(division)
        alert(message="El resultado de la división es: " + resultado_division)
