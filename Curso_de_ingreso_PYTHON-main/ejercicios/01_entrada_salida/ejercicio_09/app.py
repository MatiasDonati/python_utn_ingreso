...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        sueldo_con_incremento = str(sueldo + ( sueldo * ( incremento / 100 )))
        alert(message="El importe de sueldo actualizado con el incremento porcentual es de: " + "$"+sueldo_con_incremento)
