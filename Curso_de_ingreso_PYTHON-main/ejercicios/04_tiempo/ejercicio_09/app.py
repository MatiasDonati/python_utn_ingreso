...
class App(customtkinter.CTk):
    ...
    def btn_check_all_press(self):
            ...
            tiempo_total = int(tiempo_final - self.tiempo_inicial)
            alert(message=f"Desde que todos los botones se hicieron visibles, pasaron {tiempo_total} segs. hasta que pulsaste todos los botones. \n Saludos!")
